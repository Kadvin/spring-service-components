...
public class InvocationResponseMessageTest {
    public static final String NORMAL_JSON  = "{\"value\":\"normal value\",\"error\":null}";
    public static final String ERROR_JSON_1 = "{\"value\":null";
